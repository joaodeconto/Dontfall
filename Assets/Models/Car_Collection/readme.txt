...
This collection contains 18 different types of cars.

To use them, just drag the prefab into your scene
and just the "Car-Color-Script" to change to color 
of your car.
...
-Wheel Mesh Data optimized (cars sharing the same wheels now to save Mesh-Memory)
-Less Materials for wheels
