...
static function GetPeakValue (Coefs : float[], grip, gripRange, drift : float) : Vector2
	{
...
static function GetSlope (Coefs : float[], Slip, Value : float) : float
	{
...
static function GetValue (Coefs : float[], Slope, Slip : float) : float
	{
	var lineSlope : float;
	var x0 : float;
	var y0 : float;
...
private static function GetSpLineMax (Slip0, Value0, Slip1, Value1 : float) : Vector2
	{
	var s : float;
	var s2 : float;
	var s3 : float;
