...
private var m_CarInput : CarInput;
...
private function CreateGraph(rangeX, rangeY : float)
	{
...
private function UpdateGraph()
	...
	if (m_recValues.Count > 0)
		...
		m_Graph.LineGraph(m_recValues, 3);		
		}
	}
...
private function SetServiceMode(Car : CarControl, serviceMode : boolean, freezeRotation : boolean)
	...
	var Settings : CarSettings = Car.GetComponent(CarSettings);
	if (Settings)
...
function FixedUpdate ()
	...
	var ActiveCar = m_CarInput.getSelectedCar();	
	if (m_Car != ActiveCar)
		{
		if (m_Car) SetServiceMode(m_Car, false, false);
