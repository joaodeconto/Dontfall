...
function Start ()
	...
	m_skidmarks = FindObjectOfType(Skidmarks);
	m_skidSmoke = m_skidmarks.GetComponentInChildren(ParticleEmitter);
...
function Update () 
	...
	var steerL = m_Car.WheelFL.getWheelCollider().steerAngle;
	var steerR = m_Car.WheelFR.getWheelCollider().steerAngle;	
...
function DoWheelVisuals(Wheel : CarWheel, Graphic, Pivot : Transform, wheelData : WheelVisualData)
	{
